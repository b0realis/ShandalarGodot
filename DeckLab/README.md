...
`paces_draws`, `holds_duplicates`, `animates_to_attack`, `times_sweeps`, `trusts_abyss`, `minds_pain`, `fits_auras`, `feeds_worst`, `counter_threshold=4,5,6`, `aggression=0.3,0.7`, ...); the values read as
