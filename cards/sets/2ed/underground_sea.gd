extends CardScript
## Underground Sea — Land — Island Swamp (2ed, rare)
## Oracle: ({T}: Add {U} or {B}.)
##
...
## SUBTYPES. The subtypes are rules-relevant: islandwalk and swampwalk see
...
func build() -> CardData:
	return CardData.new("Underground Sea", "", Mtg.CardType.LAND) \
