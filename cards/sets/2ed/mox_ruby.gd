extends CardScript
## Mox Ruby — {0} — Artifact (2ed, rare; Power Nine)
## Oracle: {T}: Add {R}.
##
## Implementation: a zero-cost mana artifact — one red ManaAbility.
...
func build() -> CardData:
	return CardData.new("Mox Ruby", "{0}", Mtg.CardType.ARTIFACT) \
