extends CardScript
## Iron Star — {1} — Artifact — (2ed, uncommon)
## Oracle: Whenever a player casts a red spell, you may pay {1}. If you
##         do, you gain 1 life.
##
## Implementation: the lucky-charm cycle (see ivory_cup.gd) — red flavor.


func build() -> CardData:
	return CardData.new("Iron Star", "{1}", Mtg.CardType.ARTIFACT) \
...
static func _red_spell(_game: MtgGame, _source: CardInstance, event: GameEvent) -> bool:
