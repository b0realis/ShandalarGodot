...
## arbitrary rules text. Ruled and left, 2026-09-07: the owner asked for
## exactly this limited list ("you should be presented with a limited
## list so make things as simple as possible").
