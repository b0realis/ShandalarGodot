extends CardScript
## Wooden Sphere — {1} — Artifact — (2ed, uncommon)
## Oracle: Whenever a player casts a green spell, you may pay {1}. If you
##         do, you gain 1 life.
##
## Implementation: the lucky-charm cycle (see ivory_cup.gd) — green flavor.


func build() -> CardData:
	return CardData.new("Wooden Sphere", "{1}", Mtg.CardType.ARTIFACT) \
...
static func _green_spell(_game: MtgGame, _source: CardInstance, event: GameEvent) -> bool:
