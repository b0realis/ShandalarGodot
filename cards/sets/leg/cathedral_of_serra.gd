extends CardScript
## Cathedral of Serra — Land — (leg, uncommon)
## Oracle: White legendary creatures you control have "bands with
...
## controller's white legendary creatures "bands with other
...
func build() -> CardData:
	return CardData.new("Cathedral of Serra", "", Mtg.CardType.LAND) \
		.static_ability(StaticAbility.new(
			_apply,
			"White legendary creatures you control have bands with other "
			+ "legendary creatures.")) \
		.oracle("White legendary creatures you control have \"bands with other "
			+ "legendary creatures.\"")
