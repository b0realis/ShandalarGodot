extends CardScript
## Unholy Citadel — Land — (leg, uncommon)
## Oracle: Black legendary creatures you control have "bands with
...
## controller's black legendary creatures "bands with other
...
func build() -> CardData:
	return CardData.new("Unholy Citadel", "", Mtg.CardType.LAND) \
