...
| `set_icon_leg.png` | Legends — a fluted column, 48x48 | `tools/draw_our_art.gd` (`_column`) | GPL-3.0 | `72d6fe552d2589a424a75e56e882abc95054729c8510cbf93315a5a042051b3a` |
...
| `damage_marker.png` | the dagger on a wounded creature, 64x40 | `tools/draw_our_art.gd` (`_dagger_blade`, `_dagger_hilt`) | GPL-3.0 | `8e044fe072758359e10be8c3b82cbef4a8801107bdfe988cdf2ebf563488e6d3` |
