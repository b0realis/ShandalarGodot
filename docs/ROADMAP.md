...
* **The Weissman lists.** The Winter 1994–95 list is playable and was
  ...
  horizon); the 1995-05 and 1996 lists refused to load here — cards
  outside the pool, the Lab's proxy message — so the Winter list was
  the only Weissman control of the pass.
