...
Development source: `main`, version **0.40.15**. A desktop LAN full-pool duel
...
Use matching **0.40.15 development builds** and enabled packs on both computers. The older
