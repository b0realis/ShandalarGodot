...
Development source: `main`, version **0.40.17**. A desktop LAN full-pool duel
...
Use matching **0.40.17 development builds** and enabled packs on both computers. The older
