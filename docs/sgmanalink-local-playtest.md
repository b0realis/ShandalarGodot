...
Development source: `main`, version **0.40.16**. A desktop LAN full-pool duel
...
Use matching **0.40.16 development builds** and enabled packs on both computers. The older
