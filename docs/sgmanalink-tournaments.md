...
Development implementation on `main`, **0.40.3** (protocol **21**). Internet play, permanent accounts,
...
build fingerprint. Use matching 0.40.3 builds and enabled packs for recovery.
