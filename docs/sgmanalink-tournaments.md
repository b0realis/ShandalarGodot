...
Development implementation on `main`, **0.40.13** (protocol **24**). Internet play, permanent accounts,
...
build fingerprint. Use matching 0.40.13 builds and enabled packs for recovery.
...
1. Use matching builds (0.40.13 uses protocol 24) and enabled card packs. Open the globe, choose a
