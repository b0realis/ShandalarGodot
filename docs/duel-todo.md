...
| 9.6 | `Main phase: play a land or cast spells. Done to go to combat.` | the four `@PROMPT_MAIN` variants, which say whether the land drop is still available | `UIStrings.txt:1063`; §6.7 | `duel_screen.gd:470,474` |
